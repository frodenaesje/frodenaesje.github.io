...
entry gives the section number and the print page number, so you can jump
straight to it in Bookshelf. Spotted an error we have not listed yet? Please
email [frode.nasje@gmail.com](mailto:frode.nasje@gmail.com).

*Last updated: 22 August 2026*

| Section | Page | Reads | Should read |
|:-------:|:----:|-------|-------------|
